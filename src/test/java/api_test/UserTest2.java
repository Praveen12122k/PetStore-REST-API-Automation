...
public class UserTest2 {
    ...
    public  void test_postuser(){
       ...
       Response post_response= UserEndpoints2.create_user(payload);
    ...
    public void test_getuser(){
        Response get_response=UserEndpoints2.get_user(this.payload.getUsername());
    ...
    public  void test_updateuser(){
        ...
        Response put_response=UserEndpoints2.update_user(payload,this.payload.getUsername());
    ...
    public void test_deleteuser(){
        Response delete_user=UserEndpoints2.delete_user(this.payload.getUsername());
